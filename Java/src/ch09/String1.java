...
//		==의 같다는 의미는 데이터가 있는 주소가 같다
		if (str1 == str2) System.out.println("str1과 str2가 같다");
		else System.out.println("str1과 str2가 다르다");
		
		if (str1 == str3) System.out.println("str1과 str2가 같다");
		else System.out.println("str1과 str2가 다르다");
		
		System.out.println("======================");
		
		
//		equals의 의미는 주소와 관계없이 내용이 같으면 같다라고 기준을 정했음
		if (str1.equals(str2)) System.out.println("str1과 str2가 같다");
		else System.out.println("str1과 str2가 다르다");
