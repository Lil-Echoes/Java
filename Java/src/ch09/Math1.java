...
//		round : 반올림 -> 4보다 작으면 버리고 5이상이면 올림
//		ceil(천장) : 현재 숫자 이상인 정수 중에서 가장 작은 수
//		floor(마루) : 현재 숫자 이하인 정수 중에서 가장 큰 수
		...
		System.out.println("c d1 = " + Math.ceil(d2));
		System.out.println("c d1 = " + Math.ceil(d3));
		System.out.println("c d1 = " + Math.ceil(d4));
