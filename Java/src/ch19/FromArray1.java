...
public class FromArray1 {
	public static void main(String[] args) {
		...
		strStream.forEach(ss->System.out.print(ss + ", "));
		...
		List<Student1> sts = Arrays.asList(new Student1("로제", 25),
				new Student1("은우", 32), new Student1("제니", 27),	new Student1("보검", 31));
		...
		stStream = sts.stream();
		stStream.forEach(n->System.out.println(n.getAge()));
